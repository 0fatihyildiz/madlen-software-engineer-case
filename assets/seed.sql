...
BEGIN
    ...
    ELSE
        ...
        NEW.metadata_id := found_metadata_id;
    END IF;
...
DROP TRIGGER IF EXISTS trigger_manage_dynamic_metadata ON questions;
CREATE TRIGGER trigger_manage_dynamic_metadata
...
INSERT INTO questions (id, question_text, context_pages, difficulty_level, cognitive_level, key_concepts, course_name, model_answer_id, grading_criteria)
VALUES
